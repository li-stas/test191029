...
public class TestCollect {
        ...
        while (!lExit) {
            ...
            switch (nChoice) { 
                case 1: //System.out.println("1. ArrayList                     ");
                    ...
                    mTestList(dbArrayList,nCntAdd,aStatistics[0]);
                ...
                case 4: //System.out.println("4. HashMap                       ");
                    ...
                    mTestMap(dbHashMap,  nCntAdd, aStatistics[3]);
                ...
                case 5: //System.out.println("5. TreeMap                       ");
                    ...
                    mTestMap(dbTreeMap,  nCntAdd, aStatistics[4]);
    ...
    private static void mTestSet(Set<Student> dbHashSet, int nCntAdd, long[] aStatistic) {
        Student getStudent;
    ...
    private static void mTestMap(Map<String, Student> dbHashMap, int nCntAdd, long[] aStatistic) {
        Student getStudent;
        long startTime = System.currentTimeMillis();
        for (int i = 1; i <= nCntAdd; i++  ){
    ...
    private static void mTestList(List<Student> dbArrayList, int nCntAdd, long[] aStatistic) {
        Student getStudent;
        long startTime = System.currentTimeMillis();
        for (int i = 1; i <= nCntAdd; i++  ){
